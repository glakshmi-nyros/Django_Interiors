...
$("#design_2").click(function(){
       $("#design_2").toggleClass("blue")
});
$("#design_3").click(function(){
       $("#design_3").toggleClass("blue")
});
$("#design_4").click(function(){
       $("#design_4").toggleClass("blue")
});
$("#design_5").click(function(){
       $("#design_5").toggleClass("blue")
});
$("#design_6").click(function(){
       $("#design_6").toggleClass("blue")
});
$("#design_7").click(function(){
       $("#design_7").toggleClass("blue")
});
